# Twelve-page static site

Next.js static export for `/`, `/products/`, `/products/m-350/`, `/applications/`, five application-detail routes, `/request-a-quote/`, `/thank-you/`, and `/privacy-policy/`. There is no WordPress runtime, database, custom API server or form backend. Content belongs to D23; D32 implements and publishes approved changes.
...
- `content/home.json`, `products.json`, `m350.json`, `applications.json`, `rfq.json`, `thank-you.json`, `privacy.json`, `chrome.json`, and `content/application-details/*.md`: approved content and shared navigation; all committed with the code.
