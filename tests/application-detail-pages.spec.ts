...
test("robots and sitemap expose exactly all 25 content pages", async ({
  request,
}) => {
  ...
  expect([...urls].sort()).toEqual(
    [
      ...
      "https://tio2products.com/request-a-quote/",
      "https://tio2products.com/thank-you/",
      "https://tio2products.com/privacy-policy/",
    ].sort(),
  );
