...
import { projectMalaysiaGlobalChrome } from "@/lib/content/tio2-my-global-chrome-public";

import {
  MalaysiaGlobalFooterClient,
  MalaysiaGlobalHeaderClient,
} from "./malaysia-global-chrome-client";
...
export function MalaysiaGlobalHeader({
  ...
  return (
    <MalaysiaGlobalHeaderClient
      ...
      currentHref={
        chrome.navigation.find((item) => item.targetPageId === currentPageId)
          ?.href ?? null
      }
